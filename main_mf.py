...
def train(**kwargs):
    ...
    for epoch in range(model_param["num_epoch"]):
        ...
        metric_result, eval_log, eval_result  = evaluate(model, val_data_loader, [3,5])
    ...
    test_metric, test_log, test_result =  evaluate(model, test_data_loader, top_k_list=[3,5])
